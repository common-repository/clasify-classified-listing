...
if ( isset( $archive_setting ) && ! empty( $archive_setting ) ) {
	...
	$fields = array(
		...
		'content_section'   => array(
			'top_left'  => array( 'listing_category' ),
...
<div <?php post_class( $listing_columns . ' col-sm-12 listing_data' ); ?> id="post-<?php the_ID(); ?>" data-listing="<?php echo esc_attr( $value ); ?>">
	<div class="property-listing property-list">
		...
		<div class="thumbnail-section lazy-section">
			<div class="clasify-classified-plugin-thumb-sec top-left"><?php $provider->render_loop_sections( $fields['thumbnail_section']['top_left'] ); ?></div>
			<div class="clasify-classified-plugin-thumb-sec top-right"><?php $provider->render_loop_sections( $fields['thumbnail_section']['top_right'] ); ?></div>
			<div class="clasify-classified-plugin-thumb-sec bottom-left"><?php $provider->render_loop_sections( $fields['thumbnail_section']['bottom_left'] ); ?></div>
			<div class="clasify-classified-plugin-thumb-sec bottom-right"><?php $provider->render_loop_sections( $fields['thumbnail_section']['bottom_right'] ); ?></div>
