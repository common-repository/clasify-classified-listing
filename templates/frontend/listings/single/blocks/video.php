...
$placeholder    = null;
if ( isset( $property_video['clasify_classified_plugin_video_img'] ) && ! empty( $property_video['clasify_classified_plugin_video_img'] ) ) {
	$placeholder = wp_get_attachment_image( $property_video['clasify_classified_plugin_video_img'][0], array( '1200', '600' ) );
}
if ( isset( $property_video['clasify_classified_plugin_video_url'] ) ) {
	$video_url = $property_video['clasify_classified_plugin_video_url'];
		...
		<div class="property_video">
			<div class="thumb">
				<?php if ( empty( $placeholder ) ) { ?>
					...
					?>
					<a href="<?php echo esc_attr( $property_video['clasify_classified_plugin_video_url'] ); ?>" data-toggle="modal" data-target="#popup-video" class="theme-cl">
