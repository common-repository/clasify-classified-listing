...
if ( $comments ) {
	...
	<div class="style-2">
		...
		<div class="property_block_wrap_header">
			<h4 class="property_block_title"><?php echo esc_html__( get_comments_number() . ' Reviews', 'clasify-classified-listing' ); ?></h4>
		</div>
		<div>
	...
	echo esc_html__( 'Be the first one to rate this.', 'clasify-classified-listing' );
}
