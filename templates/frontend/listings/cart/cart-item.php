<li class="cl-cart-item">
    <div class="cart-item-details">
        <span class="cl-cart-item-title">{item_title}</span></span><?php echo CCP()->common->options->cl_item_quantities_enabled() ? '<span class="cl-cart-item-quantity">{item_quantity}&nbsp;@&nbsp;</span>' : ''; ?><span class="cl-cart-item-price">{item_amount}</span>
    </div>
