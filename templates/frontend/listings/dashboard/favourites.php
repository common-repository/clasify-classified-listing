		...
		<div id="favourite_item_<?php echo esc_attr( $single_post_id ); ?>" class="col-md-12 col-sm-12 col-md-12">
			<div class="singles-dashboard-list">
				...
				<div class="sd-list-right">
					...
					<div class="action">
						<a href="<?php echo esc_url( get_permalink( $single_post_id ) ); ?>" data-toggle="tooltip" data-placement="top" title="View Property"><i class="far fa-eye"></i><?php echo esc_html__( ' View', 'clasify-classified-listing' ); ?></a>
						<a href="javascript:void(0)" data-userid="<?php echo esc_attr( $current_user->ID ); ?>" data-postid="<?php echo esc_attr( $single_post_id ); ?>" class="remove-from-favorite prt_saveed_12lk" id="like_listing <?php echo esc_attr( $single_post_id ); ?>"><i class="far fa-trash-alt"></i><?php echo esc_html__( ' Remove', 'clasify-classified-listing' ); ?></a>
					</div>
				</div>
			</div>
		</div>
