...
<div class="column form-group col-md-12" data-group_field_id="<?php echo esc_attr( $args['field_data']['id'] ); ?>">
	...
	<textarea id="<?php echo 'add_' . esc_attr( $args['id'] ); ?>" class="form-control cl_add_field" name="<?php echo esc_attr( $args['id'] ); ?>" id="" cols="30" rows="10"><?php echo esc_attr( $value ); ?></textarea>
</div>
