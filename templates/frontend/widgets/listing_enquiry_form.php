...
class Listing_Enquiry_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p><label for="<?php printf( $this->get_field_id( 'shortcode' ) ); ?>"><?php _e( 'Shortcode:' ); ?></label>
			<input placeholder="<?php echo esc_attr__( 'Keep Empty to get default Enquiry Form', 'clasify-classified-listing' ); ?>" class="widefat" id="<?php printf( $this->get_field_id( 'shortcode' ) ); ?>" name="<?php printf( $this->get_field_name( 'shortcode' ) ); ?>" type="text" value="<?php printf( $shortcode ); ?>" />
		</p>
		<?php
	}
}
