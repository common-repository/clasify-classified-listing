	...
	public function cl_archive_builder_setting() {
		...
		<div class="archive_builder_container">
			<div class="div_element_main">
				<h3><?php echo esc_html__( 'Customize the Archive page', 'clasify-classified-listing' ); ?></h3>
				<p><a target="_blank" href="https://doc.smartdatasoft.net"><?php echo esc_html__( 'Need help?', 'clasify-classified-listing' ); ?></a></p>
			</div>
			<div class="archive_builder_row">
				...
				<div class="property-listing property-list archive_builder-section enabled">
					<div class="thumbnail-section lazy-section">
						<div data-item_type="thumbnail_section" data-item_val="top_left" class="clasify-classified-plugin-thumb-sec top-left archive_builder-section"><?php $this->field_gen( $archive_settings, 'thumbnail_section', 'top_left' ); ?></div>
						<div data-item_type="thumbnail_section" data-item_val="top_right" class="clasify-classified-plugin-thumb-sec top-right archive_builder-section"><?php $this->field_gen( $archive_settings, 'thumbnail_section', 'top_right' ); ?></div>
						<div data-item_type="thumbnail_section" data-item_val="bottom_left" class="clasify-classified-plugin-thumb-sec bottom-left archive_builder-section"><?php $this->field_gen( $archive_settings, 'thumbnail_section', 'bottom_left' ); ?></div>
						<div data-item_type="thumbnail_section" data-item_val="bottom_right" class="clasify-classified-plugin-thumb-sec bottom-right archive_builder-section"><?php $this->field_gen( $archive_settings, 'thumbnail_section', 'bottom_right' ); ?></div>
