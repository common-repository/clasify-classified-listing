(function($) {
    ...
    jQuery( document ).ready(function( $ ) {
        ...
        $('.plus-icon').on("click", function(){
            if($(this).next('.clasify-classified-plugin-modal-container').is(":visible")){
                $(this).next('.clasify-classified-plugin-modal-container').hide();
            }else{
                $('.clasify-classified-plugin-modal-container:visible').hide()
                $(this).next('.clasify-classified-plugin-modal-container').show();
            }
        })
        $(document).on("click",'.element_inactive', function(){
            ...
            if($(this).closest('.div_element_main').siblings(".clasify-classified-plugin-modal-container").length){
                $(this).closest('.div_element_main').siblings(".clasify-classified-plugin-modal-container").find('.option-card-body').append(clonehtml);
            }
            if($(this).closest('.div_element_main').parent().siblings(".clasify-classified-plugin-modal-container").length){
                $(this).closest('.div_element_main').parent().siblings(".clasify-classified-plugin-modal-container").find('.option-card-body').append(clonehtml);
            }
        ...
        $(document).on("click",'.element_active', function(){
            ...
            if(typeof(datadiv) !="undefined"){
                ...
                $(this).closest('.div_element_main').closest('.clasify-classified-plugin-modal-container').prev('.plus-icon').before( clonehtml)
            }
            $(this).closest('.div_element_main').replaceWith('');
            dand()
        ...
        $(document).on("click",'.cptm-header-action-close', function(event){
            ...
            $(this).closest('.clasify-classified-plugin-modal-container').hide()
        })
