...
$placeholder_url = CLASIFY_CLASSIFIED_PLUGIN_ASSETS . '/img/placeholder.png';
...
<div class="column col-<?php echo esc_attr( $group_columns ); ?>" data-group_field_id="<?php echo esc_attr( $cl_meta_group_field['id'] ); ?>">
	...
	<div class="mb_gal__container" data-key="<?php echo esc_attr( $key ); ?>">
		...
		<div class="button_control">
			<button data-name="<?php echo esc_attr( $meta_group_clone_val['cl_name'] ); ?>" id="<?php echo esc_attr( $cl_meta_group_field['id'] ) . $key; ?>" type="button" class="mb_btn mb_img_upload_btn"><?php echo esc_html__( 'Upload Images', 'clasify-classified-listing' ); ?></button>
			<button data-placeholder="<?php echo esc_attr( $placeholder_url ); ?>" id="<?php echo esc_attr( $cl_meta_group_field['id'] ) . $key; ?>" type="button" class="mb_btn cl_mb_clear_btn"><?php echo esc_html__( 'Clear', 'clasify-classified-listing' ); ?></button>
		</div>
	</div>
	<!-- Image -->
