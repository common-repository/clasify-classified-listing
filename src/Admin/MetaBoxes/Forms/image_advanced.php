...
<div class="column col-<?php echo esc_html( $columns ); ?>">
	...
	<div class="mb_gal__container">
		...
		<div class="button_control">
			<button data-name="<?php echo esc_attr( $cl_meta_field['id'] ); ?>" id="<?php echo esc_attr( $cl_meta_field['id'] ); ?>" type="button" class="mb_btn mb_img_upload_btn"><?php echo esc_html__( 'Upload Images', 'clasify-classified-listing' ); ?></button>
			<button data-placeholder="<?php echo esc_attr( $placeholder_url ); ?>" id="<?php echo esc_attr( $cl_meta_field['id'] ); ?>" type="button" class="mb_btn cl_mb_clear_btn"><?php echo esc_html__( 'Clear', 'clasify-classified-listing' ); ?></button>
		</div>
	</div>
	<?php if ( ! empty( $desc ) ) { ?>
