...
use Clasify\Classified\Common\Provider\Provider;
...
class Single {
	...
	protected function single_thumbnail_type_html() {
		return '<div class="mfp-gallery"><img src="' . CLASIFY_CLASSIFIED_PLUGIN_ASSETS . '/img/placeholder-single.png" class="img-fluid mx-auto" alt="' . esc_attr__( 'Placeholder', 'clasify-classified-plugin' ) . '"></div>';
	}

	protected function single_gallery_type_html() {
		 return '<div class="mfp-gallery"><img src="' . CLASIFY_CLASSIFIED_PLUGIN_ASSETS . '/img/placeholder-gallery.png" class="img-fluid mx-auto" alt="' . esc_attr__( 'Placeholder', 'clasify-classified-plugin' ) . '"></div>';
	}
	...
	protected function single_title_type_html() {
		return '<div class="single-element">' . esc_html__( 'Title', 'clasify-classified-listing' ) . '</div>';
	}

	protected function single_features_type_html() {
		return '<div class="single-element">' . esc_html__( 'Types', 'clasify-classified-listing' ) . '</div>';
	}

	protected function single_location_type_html() {
		return '<div class="single-element">' . esc_html__( 'Location', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_address_type_html() {
		return '<div class="single-element">' . esc_html__( 'Address', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_ratings_type_html() {
		return '<div class="single-element">' . esc_html__( 'Rating', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_publishdate_type_html() {
		return '<div class="single-element">' . esc_html__( 'Publish Date', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_viewcount_type_html() {
		return '<div class="single-element">' . esc_html__( 'View Count', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_status_type_html() {
		return '<div class="single-element">' . esc_html__( 'Status', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_price_type_html() {
		return '<div class="single-element">' . esc_html__( 'Price', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_meta_features_type_html() {
		return '<div class="single-element">' . esc_html__( 'Meta Features', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_share_type_html() {
		return '<div class="single-element">' . esc_html__( 'Social Share', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_cart_type_html() {
		return '<div class="single-element">' . esc_html__( 'Cart', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_favourite_type_html() {
		return '<div class="single-element">' . esc_html__( 'Favourite', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_compare_type_html() {
		return '<div class="single-element">' . esc_html__( 'Compare', 'clasify-classified-listing' ) . '</div>';
	}
	protected function single_abuse_type_html() {
		return '<div class="single-element">' . esc_html__( 'Report Abuse', 'clasify-classified-listing' ) . '</div>';
	}
