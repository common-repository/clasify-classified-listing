...
class Archive {
	...
	protected function types_archive_setting_html( $a ) {
		...
		return '<span class="single-element _list_blickes _netork" data-type="types"><input type="hidden" name="archive_setting[sectionone][sectiononeleft][types]"><input class="active_inactive_input " type="hidden" name="archive_setting[sectionone][sectiononeleft][types][active]" value="' . esc_attr( $a ) . '">Types</span>';
	}

	protected function price_archive_setting_html( $a ) {
		return '<div class="single-element"><input type="hidden" name="archive_setting[sectionone][sectiononeright][price]"><input class="active_inactive_input " type="hidden" name="archive_setting[sectionone][sectiononeright][price]active]" value="' . esc_attr( $a ) . '">Price</div>';
	}

	protected function title_archive_setting_html( $a ) {
		return '<div class="single-element"><input type="hidden" name="archive_setting[sectiontwo][title]"><input class="active_inactive_input " type="hidden" name="archive_setting[sectiontwo][title][active]" value="' . esc_attr( $a ) . '">Title</div>';
	}

	protected function excerpt_archive_setting_html( $a ) {
		return '<div class="single-element"><input type="hidden" name="archive_setting[sectiontwo][excerpt]"><input class="active_inactive_input " type="hidden" name="archive_setting[sectiontwo][excerpt][active]" value="' . esc_attr( $a ) . '">excerpt</div>';
	}

	protected function features_archive_setting_html( $a ) {
		return '<div class="single-element list-fx-features"><input type="hidden" name="archive_setting[sectiontwo][features]"><input class="active_inactive_input " type="hidden" name="archive_setting[sectiontwo][features][active]" value="' . esc_attr( $a ) . '">Features</div>';
	}

	protected function location_archive_setting_html( $a ) {
		return '<div class="footer-flex"><input type="hidden" name="archive_setting[sectionfive][sectionfiveleft][location]"><input class="active_inactive_input " type="hidden" name="archive_setting[sectionfive][sectionfiveleft][location][active]" value="' . esc_attr( $a ) . '"><div class="single-element foot-location">Location</div></div>';
	}
