<?php
namespace Clasify\Classified\Common\Customer;

use Clasify\Classified\Common\Customer\Dbcustomer;
use Clasify\Classified\Common\Customer\Customerquery;
...
class Customer {
	...
	public function __get( $key ) {
		...
		if ( method_exists( $this, 'get_' . $key ) ) {
			...
			return new WP_Error( 'cl-customer-invalid-property', sprintf( __( 'Can\'t get property %s', 'clasify-classified-listing' ), $key ) );
		}
	}
	...
	public function get_meta( $meta_key = '', $single = true ) {
		return CCP()->common->customermeta->get_meta( $this->id, $meta_key, $single );
	}
	...
	public function add_meta( $meta_key, $meta_value, $unique = false ) {
		return CCP()->common->customermeta->add_meta( $this->id, $meta_key, $meta_value, $unique );
	}
	...
	public function update_meta( $meta_key, $meta_value, $prev_value = '' ) {
		return CCP()->common->customermeta->update_meta( $this->id, $meta_key, $meta_value, $prev_value );
	}
	...
	public function delete_meta( $meta_key = '', $meta_value = '' ) {
		return CCP()->common->customermeta->delete_meta( $this->id, $meta_key, $meta_value );
	}
