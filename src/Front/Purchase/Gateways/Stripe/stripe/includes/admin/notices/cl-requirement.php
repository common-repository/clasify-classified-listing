...
<p>
	...
	echo wp_kses(
		sprintf(
			...
			__( 'To continue accepting credit card payments with Stripe please update %1$sClasify Classified Plugin%2$s to version %3$s2.9%4$s or higher.', 'clasify-classified-listing' ),
			'<strong>',
			'</strong>',
			'<code>',
			'</code>'
