...
function cls_register_post_statuses() {
	register_post_status(
		'preapproval_pending',
		array(
			'label'                     => _x( 'Preapproval Pending', 'Pending preapproved payment', 'clasify-classified-listing' ),
			'public'                    => true,
	...
	register_post_status(
		'preapproval',
		array(
			'label'                     => _x( 'Preapproved', 'Preapproved payment', 'clasify-classified-listing' ),
			'public'                    => true,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
	...
	register_post_status(
		'cancelled',
		array(
			'label'                     => _x( 'Cancelled', 'Cancelled payment', 'clasify-classified-listing' ),
			'public'                    => true,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
...
function cl_stripe_register_email_tags() {
	...
	if ( ! empty( $statement_descriptor ) ) {
		cl_add_email_tag(
			...
			__( 'Outputs a line stating what charges will appear as on customer\'s credit card statements.', 'clasify-classified-listing' ),
			'cl_stripe_statement_descriptor_template_tag',
			__( 'Statement Descriptor', 'clasify-classified-listing' )
		);
	}
}
...
function cl_stripe_statement_descriptor_template_tag( $payment_id ) {
	...
	$email_tag_output = __( apply_filters( 'cl_stripe_statement_descriptor_email_tag', 'Charges will appear on your card statement as %s' ), 'clasify-classified-listing' );
