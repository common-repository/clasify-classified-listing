...
class Clpaymentstats {
	...
	public function get_predefined_dates() {
		$predefined = array(
			'today'        => __( 'Today', 'clasify-classified-listing' ),
			'yesterday'    => __( 'Yesterday', 'clasify-classified-listing' ),
			'this_week'    => __( 'This Week', 'clasify-classified-listing' ),
			'last_week'    => __( 'Last Week', 'clasify-classified-listing' ),
			'this_month'   => __( 'This Month', 'clasify-classified-listing' ),
			'last_month'   => __( 'Last Month', 'clasify-classified-listing' ),
			'this_quarter' => __( 'This Quarter', 'clasify-classified-listing' ),
			'last_quarter' => __( 'Last Quarter', 'clasify-classified-listing' ),
			'this_year'    => __( 'This Year', 'clasify-classified-listing' ),
			'last_year'    => __( 'Last Year', 'clasify-classified-listing' ),
		);
	...
	public function convert_date( $date, $end_date = false ) {
		...
		if ( ( is_string( $date ) || is_int( $date ) ) && array_key_exists( $date, $this->get_predefined_dates() ) ) {
			...
			return new WP_Error( 'invalid_date', __( 'Improper date provided.', 'clasify-classified-listing' ) );
		}
	...
	public function get_earnings( $listing_id = 0, $start_date = false, $end_date = false, $include_taxes = true ) {
		...
		return round( $result, CCP()->common->formatting->cl_currency_decimal_filter() );
	}
